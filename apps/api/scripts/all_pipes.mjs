...
// 10 páginas = 1000 opps, agrupa por pipelineId
const counts = {};
for (let page = 1; page <= 10; page++) {
  ...
  for (const o of j.opportunities ?? []) counts[o.pipelineId] = (counts[o.pipelineId] ?? 0) + 1;
}
console.log("=== todos os pipelineIds (amostra 1000 opps) ===");
